"""
KOHLER CONCORD — Evaluation Dashboard.

Renders pass rate, category breakdown chart, test results table,
and user feedback summary.  Pure presentation — no data logic changes.
"""
...
def render_eval_dashboard(results: List[EvalResult]) -> None:
    ...
    if fb["total"] > 0:
        ...
        st.info(
            "No feedback collected yet. Interact with the chat and "
            "rate answers to see metrics here."
        )
